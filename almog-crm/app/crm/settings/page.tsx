          ...
          <nav style={{ display: 'flex', gap: '4px' }}>
            {[
              ...
              <Link key={item.href} href={item.href} style={{
                color: item.href === '/crm/settings' ? '#fff' : 'rgba(255,255,255,.45)',
                fontSize: '.82rem',
                textDecoration: 'none',
                padding: '6px 12px',
                borderRadius: '8px',
                background: item.href === '/crm/settings' ? 'rgba(255,255,255,.1)' : 'transparent',
                fontWeight: item.href === '/crm/settings' ? 700 : 400,
              }}>
                {item.label}
              </Link>
            ))}
